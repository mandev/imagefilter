...
public class InvertAlphaPanelFilter extends AbstractPanelFilter implements ChangeListener {

    private JPanel panel;

    @Override
    public String getName() {
        return Message.get("InvertAlphaFilter");
    }
