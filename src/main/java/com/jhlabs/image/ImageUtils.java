...
public abstract class ImageUtils {
    ...
    /**
     * Convert an Image into a TYPE_INT_ARGB BufferedImage. If the image is
     * already of this type, the original image is returned unchanged.
     *
    ...
    /**
     * Returns a *copy* of a subimage of image. This avoids the performance
    ...
    /**
     * Compose src onto dst using the alpha of sel to interpolate between the
     * two. I can't think of a way to do this using AlphaComposite.
     *
