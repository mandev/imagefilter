...
public class ShineFilter extends AbstractBufferedImageOp {
    ...
    public BufferedImage filterRGB32(BufferedImage src, BufferedImage dst) {
        ...
        g.drawRenderedImage(matte, null);
        g.dispose();
        shineLayer = new GaussianFilter(radius).filterRGB32(shineLayer, null);
        shineLayer = new RescaleFilter(3 * brightness).filterRGB32(shineLayer, shineLayer);
