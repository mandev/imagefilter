...
public class WarpGrid {
    ...
    /**
     * Add a new row to the grid. "before" must be in the range 1..rows-1. i.e.
     * you can only add rows inside the grid.
     */
    ...
    /**
     * Add a new column to the grid. "before" must be in the range 1..cols-1.
     * i.e. you can only add columns inside the grid.
     */
