...
public class LightFilter extends WholeImageFilter {
    ...
    protected void setFromRGB(Color4f c, int argb) {
        ...
        c.x = ((argb >> 16) & 0xff) * r255;
        c.y = ((argb >> 8) & 0xff) * r255;
        c.z = (argb & 0xff) * r255;
        c.w = ((argb >> 24) & 0xff) * r255;
    }
    ...
    protected int[] filterPixels(int width, int height, int[] inPixels, Rectangle transformedSpace) {
        ...
        if (bumpSource == BUMPS_FROM_IMAGE || bumpSource == BUMPS_FROM_IMAGE_ALPHA || bumpSource == BUMPS_FROM_MAP || bump == null) {
            if (bumpSoftness != 0) {
                ...
                //GaussianFilter.convolveAndTranspose(0, bumpHeight, kernel, bumpPixels, tmpPixels, bumpWidth, bumpHeight, true, false, false, GaussianFilter.WRAP_EDGES);
                        ...
                        case 1:
                            bump = new Function2D() {
                                ...
                                public float evaluate(float x, float y) {
                                    ...
                                    return v * ImageMath.smoothStep(0.45f, 0.55f, v);
                                }
                            };
                            break;
...
//         }
        ...
        System.err.println("filterPixels - time : " + (System.currentTimeMillis() - time));
        return outPixels;
    }
