 ...
 * Given a source image, a clean image and a destination image, the filter
 * replaces all pixels in the source which nearly equal the equivalent clean
 * pixel by destination pixels.
 */
