 ...
 * two warp grids, one for the source image and one for the destination image.
 * The image will be warped so that a point in the source grid moves to its
...
public class WarpFilter extends WholeImageFilter {
    ...
    /**
     * For morphing, sets the image we're morphing to. If not, set then we're
     * just warping.
     */
